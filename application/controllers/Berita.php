...
class Berita extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('template', 'berita/v_berita_data', $data);
    }
    ...
    public function add()
    {
        ...
        $this->template->load('template', 'berita/v_berita_form_add', $data);
    }
    ...
    public function edit($id)
    {
        ...
        if ($query->num_rows() > 0) {
            $data['row'] = $query->row();
            $this->template->load('template', 'berita/v_berita_form_edit', $data);
        } else {
    ...
    public function view($id)
    {
        ...
        $this->template->load('template', 'berita/v_berita_data_view', $data);
    }
