...
<section class="content">
    <div class="box">
        <div class="box-header">
            <h3 class="box-title"> Add Check Out</h3>
            <div class="pull-right">
                <a href="<?= site_url('checkout/out') ?>" class="btn btn-warning btn-flat">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="form-group">
                        <label>File Transaction </label>
                        <input type="file" name="uploadpdf" class="form-control">
                        <small>Isikan file sesuai checkout Product dengan format only PDF</small>
                    </div>
