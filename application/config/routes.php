...
$route['stock/out/edit/(:num)'] = 'stock/stock_out_edit';

// CHECK OUT
$route['checkout/out'] = 'checkout/check_out_data';
$route['checkout/out/add'] = 'checkout/check_out_add';
$route['checkout/out/delete/(:num)/(:num)'] = 'checkout/check_out_delete';
$route['checkout/out/edit/(:num)'] = 'checkout/check_out_edit';
